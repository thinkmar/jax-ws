...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements HelloWorldService {
    ...
    private String HelloWorldPort_address = "http://localhost:8080/services/HelloWorld";
    ...
    private String HelloWorldPortWSDDServiceName = "HelloWorldPort";

    public String getHelloWorldPortWSDDServiceName() {
        return HelloWorldPortWSDDServiceName;
    }

    public void setHelloWorldPortWSDDServiceName(String name) {
    ...
    public HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            HelloWorldPortBindingStub _stub = new HelloWorldPortBindingStub(portAddress, this);
    ...
    public void setHelloWorldPortEndpointAddress(String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                HelloWorldPortBindingStub _stub = new HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://thinkmar/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://thinkmar/", "HelloWorldPort"));
        }
