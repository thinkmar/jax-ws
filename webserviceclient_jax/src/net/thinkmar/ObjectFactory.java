 ...
 * generated in the net.thinkmar package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldFrom_QNAME = new QName("http://thinkmar/", "sayHelloWorldFrom");
    private final static QName _SayHelloWorldFromResponse_QNAME = new QName("http://thinkmar/", "sayHelloWorldFromResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.thinkmar
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://thinkmar/", name = "sayHelloWorldFrom")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://thinkmar/", name = "sayHelloWorldFromResponse")
