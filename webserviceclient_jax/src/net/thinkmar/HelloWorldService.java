 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://thinkmar/", wsdlLocation = "http://localhost:8080/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://thinkmar/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://thinkmar/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://thinkmar/", "HelloWorldPort"), HelloWorld.class, features);
    }
